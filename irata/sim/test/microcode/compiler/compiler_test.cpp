...
TEST_F(CompilerTest, MergeBusStepsWithNonBusSteps) {
  ...
  // and then increment pc. This is ok since the copy is done in the write and
...
TEST_F(CompilerTest, DontMergeBusMoves) {
  ...
  // correctness. In this example, copy a to x on the data bus and pc to mar on
